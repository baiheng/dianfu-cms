                            ...
                            <Col span={6}>
                                ...
                                {getFieldDecorator('type', {
                                    rules: [
                                        ...
                                        {
                                            user.conf["notification.job_guide.type"].map((item, index) => {
...
class JobGuide extends React.Component {
    ...
    getList(){
        $.ajax({
            url: "/api/v1/notification/job_guide",
            type: "GET",
            data: Object.assign({
                start: 0,
                end: 50
                        ...
                        <div className="am-g am-g-collapse">
                            ...
                            <div className="am-u-sm-3"> 
                                <div className="am-input-group am-input-group-default">
                                    <input type="text" className="am-form-field" placeholder="攻略标题名字" ref="name" />
